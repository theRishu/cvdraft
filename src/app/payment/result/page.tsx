...
function ResultContent() {
    ...
    const statusParam = params.get("status"); // "success" or "failed"
            ...
            <div className="bg-white rounded-3xl shadow-xl p-10 max-w-sm w-full text-center">
                {status === "loading" && (
                    <>
                        ...
                        <h1 className="text-xl font-black text-stone-900 mb-2">Confirming payment…</h1>
                ...
                {status === "failed" && (
                    <>
                        ...
                        <div className="flex flex-col gap-3">
                            <Link href="/premium" className="w-full py-3 bg-emerald-600 text-white font-bold rounded-2xl hover:bg-emerald-700 transition-all">
                                Try Again
                            </Link>
