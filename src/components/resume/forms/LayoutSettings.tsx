        ...
        <div className="space-y-7">
            ...
            <div>
                <div className="flex items-center gap-2 mb-3">
                    ...
                    <h4 className="text-sm font-bold text-stone-800">Font Size</h4>
                </div>
                <div className="flex gap-2">
                    {FONT_SIZES.map(s => (
                        <button
                            ...
                            className={`flex-1 py-2 rounded-xl text-xs font-semibold border transition-all ${fontSize === s.value
                                ? "bg-indigo-600 text-white border-indigo-600"
                                : "bg-stone-50 text-stone-600 border-stone-200 hover:border-indigo-300"
                                }`}
                        >
